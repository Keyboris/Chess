    ...
    public class Controller
    {
        ...
        public void Move(int from_x, int from_y, int to_i, int to_j, bool priority)
        {
            ...
            if ((Allowed_Move(board, from_x, from_y, to_i, to_j) || priority) && !paused)
            {
                ...
                Console.WriteLine("we are allowed to make a move");
                Console.WriteLine($"black king pos: {Black_King.Item1},{Black_King.Item2}");
                Console.WriteLine($"white king pos: {White_King.Item1},{White_King.Item2}");

                last_move = ((from_x, from_y), (to_i, to_j));
                Console.WriteLine($"from last: {last_move.Item1} \n to last: {last_move.Item2}");
        ...
        public bool Check_Check(Board board, ref int check)
        {
            ...
            {
                Console.WriteLine($"black king {Black_King}");
        ...
        public bool mateCheck(Board board, int player, ref int winner)
        {
            ...
            Console.WriteLine("called the right method");
        ...
        public bool Allowed_Move(Board board, int from_x, int from_y, int to_x, int to_y)
        {
            ...
            if (board[from_x, from_y] is Pieces_namespace.King)
            {
            ...
            Console.WriteLine(board[from_x, from_y]);

            Console.WriteLine($"Moving piece from ({from_x}, {from_y}) to ({to_x}, {to_y})");
            ...
            {
                Console.WriteLine("This move leaves the player in check!");
                if (white)
                {
        ...
        public void HandlePressChessBoard(int i, int j)
        {
            ...
            Console.WriteLine($"piece: {board[i, j]}");
